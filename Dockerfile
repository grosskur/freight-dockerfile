...
RUN \
  ...
  curl -fsLS -O http://nodejs.org/dist/v0.12.2/node-v0.12.2-linux-x64.tar.gz && \
  ...
  echo '4e1578efc2a2cc67651413a05ccc4c5d43f6b4329c599901c556f24d93cd0508  node-v0.12.2-linux-x64.tar.gz' | sha256sum -c && \
  ...
  tar -C /app/.local/node --strip-components=1 -xzf node-v0.12.2-linux-x64.tar.gz && \
